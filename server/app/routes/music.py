...
###     [작곡]
    ...
    # composition_path = "app/routes/data/output_audio_wav/temp.wav"
    ...
    # return FileResponse(composition_path)

    # return {'buffer': FileResponse(composition_path), 'genre': 'classic'}
